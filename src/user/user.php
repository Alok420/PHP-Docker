                    ...
                    <div class="section__content section__content--p30">
                        <DIV class="container-fluid">
                            ...
                            <div class="sparkline-list">
                                <h3 style="margin-top: 5px; padding: 5px;" align="center">User's List</h3> 
                                <br>
                                <br>
                                <?php
                                // var_dump($_GET);die;
                                ...
                                if($user['role'] == "admin"){
                                    ...
                                    $db->showInTable("user", "id,name,email,contact,role,created_at", $where, "all", $externallinks = "User detail", array(), $sort);
                                }
                                ?>
                            </div>
                        </DIV>
