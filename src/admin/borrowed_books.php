                ...
                <div class="section__content section__content--p30">
                    <DIV class="container-fluid">
                        ...
                        <div class="sparkline-list">
                            <h3 style="margin-top: 5px; padding: 5px;" align="center">Borrowed Books</h3>
                            <br>
                            <table class="table">
                                <tr>
                                    <th>Book name</th>
                                ...
                                <?php
                                $datas = $conn->query("select * from borrow_book");
                                while ($data = $datas->fetch_assoc()) {
                                    $name = $db->select("user", "name", array("id" => $data["user_id"]))->fetch_assoc()["name"];
                                    $bookname = $db->select("books", "name", array("id" => $data["books_id"]))->fetch_assoc()["name"];
                                ?>
                                    <tr>
                                        <td>$name</td>
                                        <td>$bookname</td>
